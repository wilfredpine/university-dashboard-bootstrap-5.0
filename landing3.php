...
<main class="container">
    ...
    <!--  -->
    <div class="d-flex align-items-center p-3 my-3 text-white bg-danger rounded shadow-sm mt-5">
        <img class="me-3" src="public/img/logo.png" alt="" width="auto" height="40">
        <div class="lh-1">
            <h1 class="h6 mb-0 text-white lh-1">University</h1>
    ...
    <div class="p-4 p-md-5 mb-4 text-light rounded bg-dark">
        ...
        <div class="col-md-12 px-0">
            <h6 class="display-6">Template</h6>
            <p class="lead my-3">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
            ...
            <!-- <p class="lead mb-0"><a href="#" class="text-white fw-bold">Read more...</a></p> -->
        </div>
        ...
        <div class="col-md-6">
            <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
                <div class="col p-4 d-flex flex-column position-static">
                    <!-- <strong class="d-inline-block mb-2 text-primary">Who We Are</strong> -->
                    <!-- <h3 class="mb-0">Featured post</h3>
                    <div class="mb-1 text-muted">Nov 12</div> -->
                    <p class="card-text mb-auto">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
                        eiusmod tempor
    ...
    <div class="row mb-5">
        <div class="col-md-12">
            ...
            <article class="blog-post">
                <!-- title -->
                <h4 class="blog-post-title">What We Offer</h4>
